...
{
    public class SilverJavelinWeaponInfinite : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Infinite Silver Javelin");
        }
        ...
        public override void AddRecipes()
        {
            if (ThrowingConfig.InfiniteJavelins)
            {
                ...
                recipe.AddIngredient(mod.GetItem("SilverJavelinWeapon"), 999);
