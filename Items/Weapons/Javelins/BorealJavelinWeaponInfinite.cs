...
{
    public class BorealJavelinWeaponInfinite : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Infinite Boreal Javelin");
        }
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("BorealJavelin");
        ...
        public override void AddRecipes()
        {
            if (ThrowingConfig.InfiniteJavelins)
            {
                ...
                recipe.AddIngredient(mod.GetItem("BorealJavelinWeapon"), 999);
