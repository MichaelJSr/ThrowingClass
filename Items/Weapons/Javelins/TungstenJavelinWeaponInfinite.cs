...
{
    public class TungstenJavelinWeaponInfinite : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Infinite Tungsten Javelin");
        }
        ...
        public override void AddRecipes()
        {
            if (ThrowingConfig.InfiniteJavelins)
            {
                ...
                recipe.AddIngredient(mod.GetItem("TungstenJavelinWeapon"), 999);
